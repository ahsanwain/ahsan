  ...
  return (
    ...
    <div className="app-container">
      <div className="student-form">
        <form onSubmit={(event) => (selectedStudent? handleUpdateStudent(event) : handleAddStudent(event))} method='POST'>
          ...
          <input value={email} onChange={(event) => setEmail(event.target.value)} placeholder="email" type="text" id="email" name="email" required/><br/><br/>
